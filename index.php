      ...
      <div class="container mt-3">
        <div class="row d-flex justify-content-start align-items-start main-container">
          <div class="col-md-5 col-sm-12 col-lg-5 reveal main-text mb-4 text-align-justify mt-5" data-aos="fade-up">
            <h2>Welcome to <span style="color: #fb4a36;"> Food Express,</span></h2>
            ...
            <p style="font-size: 18px; text-align: justify;">
              ...
              flavor. At Food Express, we believe in making every meal an
      ...
      <div class="container ">
        ...
        <div class="story-content row mb-2">
          <div class="story-text col-lg-6 col-md-6 col-sm-12 reveal mt-2" data-aos="fade-up" data-os-interval="300">
            <p>At <strong>Food Express</strong>, we are passionate about celebrating food. Our chefs bring a touch of creativity to every dish, ensuring a feast for your senses. Join us for an extraordinary dining experience that celebrates flavor and joy.</p>
            <p>Founded in [2020], Food Express has been at the forefront of culinary innovation. Our commitment to using the freshest ingredients, combined with our chefs' expertise, has earned us a reputation for excellence. We believe that dining is not just about eating; it's about experiencing the art of food.</p>
            <p>Whether you're looking for a romantic dinner, a family gathering, or a place to celebrate special occasions, Food Express offers the perfect ambiance and exquisite cuisine to make your visit unforgettable. Come and experience the joy of flavor with us!</p>
    ...
    <div class="footer-container">
      <div class="footer-row">
        <div class="footer-col" id="contact">
          <h4>Contact Us</h4>
          <p> Subidhanagar-32 Tinkune, Kathmandu</p>
          <p>Email: shahkks98455@gmail.com</p>
          <p>Phone: +977-9820963752</p>
        </div>
      ...
      <div class="footer-bottom">
        <h4>&copy; 2025 Authored by BIT2022Batch. All Rights Reserved.</h4>
      </div>
    </div>
  </footer>
